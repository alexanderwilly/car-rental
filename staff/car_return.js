...
function loadReservations(date, idsearch) {
    ...
    const filteredReservations = r1.filter(reservation => {
        return reservation.getEndDate().toDateString() === date.toDateString() 
...
// get select_date initial value from 20 December 2024 gmt+8 to 15/10/2024
let date = new Date(Date.UTC(2024, 11, 20));
